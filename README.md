...
#### 单词卡生成器 (wordCard.html)
- **单词输入**: 支持换行、空格、逗号、分号分隔
- **自动去重**: 自动去除重复单词
- **序号前缀**: 支持自定义序号前缀（如：Lesson1-1）
- **分页展示**: 每页12张卡片，支持键盘左右切换
- **PDF导出**: 通过浏览器打印功能导出PDF
- **响应式设计**: 适配不同屏幕尺寸
